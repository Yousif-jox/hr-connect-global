...
const copy = {
  en: {
    ...
    hero: {
      ...
      quote:
        "Acwad took our hiring and payroll off our plate completely. Time-to-fill dropped by a third.",
    ...
    footer: {
      brand: "Acwad HR",
      line: "© 2024 Acwad HR Services · Recruitment · Payroll · Compliance · Training",
    },
  },
  ar: {
    dir: "rtl" as const,
    ...
    footer: {
      brand: "اكواد للخدمات البشرية",
      line: "© ٢٠٢٤ اكواد للخدمات البشرية · التوظيف · الرواتب · الامتثال · التدريب",
    },
  },
};
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Acwad HR | Recruitment, Payroll, Compliance & Training" },
      {
        name: "description",
        content:
          "Acwad HR is your end-to-end HR partner: recruitment, payroll, compliance and training for growing teams. Bilingual EN/AR services across the region.",
      },
      { property: "og:title", content: "Acwad HR | End-to-End HR Services" },
      {
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-6 py-16 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5">
            <img
              ...
              alt={
                lang === "en"
                  ? "Acwad HR team collaborating in a modern office"
