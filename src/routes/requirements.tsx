...
const copy = {
  en: {
    ...
    note: "Acwad HR never charges candidates any fee at any stage. All offers are issued in writing from a @acwadhr.com address.",
  },
  ar: {
    ...
    note: "لا تتقاضى اكواد أي رسوم من المرشحين في أي مرحلة. وكل العروض تصدر كتابيًا من بريد @acwadhr.com فقط.",
  },
};
...
export const Route = createFileRoute("/requirements")({
  head: () => ({
    meta: [
      { title: "Hiring Requirements | Acwad HR Candidate Criteria" },
      {
        name: "description",
        content:
          "Acwad HR hiring requirements: eligibility criteria, documents to prepare and the five-stage recruitment process, in English and Arabic.",
      },
      { property: "og:title", content: "Hiring Requirements | Acwad HR" },
      {
